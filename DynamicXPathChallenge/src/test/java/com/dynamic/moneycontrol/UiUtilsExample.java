...
public class UiUtilsExample {

	public static List<String> getNamesFromWebTable(WebDriver driver) {
		...
		List<WebElement> commodityNames = driver.findElements(By.xpath(
				"//span[text()='Brent Crude']/ancestor::table[contains(@class,'commodities')]/child::tbody/tr/td[1]//a/span[1]"));
		commodityNames.size();
